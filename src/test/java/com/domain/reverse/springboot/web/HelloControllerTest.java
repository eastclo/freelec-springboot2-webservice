...
import com.domain.reverse.springboot.config.auth.SecurityConfig;
...
@WebMvcTest(controllers = HelloController.class, //Spring test annotation 중 하나. Web(Spring MVC)에 집중
    excludeFilters = {                          //선언시 @Controller, @ControllerAdvice 등 사용 가능, @Service, @Component, @Repository 등 사용 불가
